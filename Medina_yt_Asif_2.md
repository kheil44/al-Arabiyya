...
* ذَهَبَ is the past tense verb (he went).
* The تْ at the end is called تَاءُ التَّأْنِيثِ (the "T" of feminisation). It is just a grammar sign to show that a female did the action. It is not the doer itself.
* The actual الْفَاعِل is a مُسْتَتِر (hidden) pronoun, which is هِيَ (she).
